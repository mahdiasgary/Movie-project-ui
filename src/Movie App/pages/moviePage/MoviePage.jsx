...
import { useAddMovieToWatchListUserSideMutation } from "../../redux/services/movieDatabase";
...
const MoviePage = ({ history }) => {
  ...
  let backg =
    "http://localhost:3000/static/media/avatar.584139bb57d074209a66.png";
  let cover =
    "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSmGggtpJ4TX3aN3PUaVWUgNODHespRPvKYAyhGUAZSqSOmPiEm";
  const [addTowatch] = useAddMovieToWatchListUserSideMutation();
  const toWatchListHandler = () => {
    const fromdata = new FormData();
    fromdata.append("MovieId", 1231);
    addTowatch(fromdata)
      .unwrap()
              ...
              <div className="w-full md:w-auto flex justify-center md:justify-start ">
                <div className="flex-col">
                  <img
                    src={cover}
                    alt={"k"}
                    className="min-w-[180px] shadow-2xl max-h-[265px]  lg:min-w-[200px] lg:max-h-[351px]  xl:min-w-[240px] xl:max-h-[352px] self-center  rounded-lg  "
                  />
                ...
                <div className=" flex flex-col  mx-2 xl:mx-5   md:flex-row md:justify-between ">
                  <div>
                    <div>
                      ...
                      <div className="flex md:hidden mt-3 justify-center gap-2">
                        <div className="border md:border-0 border-border px-1 rounded-lg w-[100px] h-[76px] self-center text-center  backdrop-blur-sm  bg-screenDark bg-opacity-80  ">
                          <div>
                            ...
                            <p className=" text-btn inline">/10</p>
                          </div>
                          <p className="flex text-yellow-500 justify-center text-sm ">
                            {" "}
                            <FaImdb className="self-center text-[17px]" /> Imdb
                          </p>
                        </div>
                        ...
                        <div
                          ...
                          onClick={() => {
                            toWatchListHandler(), setlikedd(!likedd);
                          }}
                        >
                          {likedd ? (
                            <MdBookmarkAdded className="self-center text-btn" />
                          ) : (
                            <MdBookmarkBorder className="self-center hover: text-btn" />
                          )}
                        </div>
                      </div>
                      <div className=" hidden md:flex justify-center md:justify-start mt-5">
                      ...
                      <p className="my-3 md:hidden  mt-12 text-sm md:text-gray-200 lg:text-[16px] ">
                        Genre :
                      ...
                      <div>
                        ...
                        <div className="flex flex-col xl:flex-row gap-2 mt-2 justify-end ">
                          <div className="border md:border-0 border-border px-1 rounded-lg w-[100px] h-[76px] self-center text-center  backdrop-blur-sm  bg-screenDark bg-opacity-80  hover:bg-screenDark  ">
                            <div className="border md:border-0 border-border px-1 rounded-lg w-[100px] h-[76px] self-center text-center  backdrop-blur-sm  bg-screenDark bg-opacity-80  ">
                              <div>
                                <p className="text-[29px] text-btn inline">
                                  8.5
                                </p>
                                <p className=" text-btn inline">/10</p>
                              </div>
                              <p className="flex text-yellow-500 justify-center text-sm ">
                                {" "}
                                <FaImdb className="self-center text-[17px]" />{" "}
                                Imdb
                              </p>
                            </div>
                          </div>
        ...
        <div className="w-full relative  z-0 group ">
          ...
          <div className="z-0 bg-screenDark   flex justify-center overflow-hidden max-h-[680px]  ">
            <img
              src={backg}
              alt=""
              className={`opacity-30    relative min-w-[1050px] md:min-w-[950px] lg:min-w-[600px] xl:min-w-[700px]  w-full xl:min-h-[625px] `}
            />
          </div>
