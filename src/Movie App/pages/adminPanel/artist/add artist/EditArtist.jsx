...
const EditArtist = ({ history }) => {
  ...
  return data ? (
    ...
    <button
      type="button"
      class="inline-flex items-center px-10 py-3  font-semibold leading-6 dark:text-screenDark text-white transition duration-150 ease-in-out  rounded-lg shadow cursor-not-allowed "
      disabled=""
    >
      <svg
        class="w-5 h-5 mr-3 -ml-1 text-white animate-spin"
