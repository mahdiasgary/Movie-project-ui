...
const AddFileItem = ({
    ...
    axios
      ...
      .then((r) => {
        ...
        if (r.data.isSuccessFull) {
          setqw(Math.random());
          // axios
          //   .get("https://localhost:7175/Admin/Movie/GetDetailById?Id=1228")
  ...
  return (
    <div className="">
      ...
      />
      <div>
        {initialInputs?.files?.find((m) => m.quality === quality) ? (
          <div
            className={`  ${
              loadingButton && "hidden"
            }   mx-2 my-1 bg-gray-300 dark:bg-border  rounded-md justify-between`}
          >
                    ...
                    <div>
                      {state.loading ? (
                        ...
                        <div
                          className={` flex ${
                            loadingButton && "hidden"
                          }    my-1 border-2 border-btn bg-whit text-gray-600 dark:bg-opacity-30 bg-opacity-50 dark:text-gray-400 dark:bg-screenDar px-1 rounded-2xl py-2 justify-between`}
                        >
                          <input
                            onChange={(e) => {
                              e.preventDefault();
                    ...
                    <div>
                      ...
                      <div className="flex justify-end">
                        <div className="flex gap-2 justify-end">
                          ...
                          <button className="duration-200 hover:text-white hover:bg-opacity-100 text-red-500 bg-opacity-20 text-[20px] bg-red-500 p-2 rounded-2xl">
                            <TbTrashFilled />
                          </button>
                        </div>
                      </div>
