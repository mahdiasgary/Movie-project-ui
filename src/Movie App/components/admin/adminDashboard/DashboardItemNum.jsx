...
const DashboardItemNum = ({data}) => {
  ...
  return (
    <div className="flex  flex-wrap gap-4 justify-">
      <div className="bg-btn text-white p-4 pl-6 rounded-3xl w-[170px] ">
        <BiSolidMoviePlay className="text-[39px] " />
        <div className="text-[25px] font-extrabold">{queryData?.movieCount}</div>
        <div className="">Movie Count</div>
      </div>
      <div className="bg-btn text-white p-4 pl-6 rounded-3xl w-[170px] ">
        <MdLocalMovies className="text-[39px] " />
        <div className="text-[25px] font-extrabold">{queryData?.seriesCount}</div>
        <div className="">Series Count</div>
      </div>
      <div className="bg-btn text-white p-4 pl-6 rounded-3xl w-[170px] ">
        <FaTheaterMasks className="text-[40px] " />
        <div className="text-[25px] font-extrabold">{queryData?.artistCount}</div>
        <div className="">Artist Count</div>
      </div>
      <div className="border-[3px] border-btn text-btn p-3 pl-5 rounded-3xl w-[170px] ">
        <MdMovieFilter className="text-[39px] " />
        <div className="text-[25px] font-extrabold">{queryData?.genereCount}</div>
