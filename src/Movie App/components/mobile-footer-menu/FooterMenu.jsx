...
const FooterMenu = ({ history, setOpenMenu, openMenu }) => {
  ...
  return (
    <div className="md:hidden shadow-t-lg fixed w-screen h-[67px] z-[30] bottom-0 flex flex-col justify-center dark:bg-[#07070a] bg-white">
            ...
            {item.title === "Menu" ? (
              ...
              >
                {item.title.toLowerCase() === selected ? (
                  <div className="self-center text-[23px] ">{item.iconP} </div>
                ) : (
              ...
              >
                <div className="flex flex-col">
                  {item.title.toLowerCase() === selected ? (
                    <div className="self-center text-[23px] ">
                      {item.iconP}{" "}
                    </div>
                  ) : (
                    <div className="self-center text-[23px] ">{item.icon} </div>
